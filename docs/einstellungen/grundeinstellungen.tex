...
\documentclass[
	...
	12pt,											% 12pt SchriftgrÃ¶Ãe
	halfparskip,										% EuropÃ¤ischer Satz: Abstand zwischen AbsÃ¤tzen
	...
	final,											% Es handelt sich um die endgÃ¼ltige Version
...
\usepackage[utf8]{inputenc}							% direkte Umlauteingabe (Ã¤ statt "a)
													% latin1/latin9 fÃ¼r unixoide Systeme
													% (latin1 ist auch unter Win verwendbar)
													% ansinew fÃ¼r Windows
													% applemac Macs
													% cp850 OS/2

\usepackage{array,ragged2e}							% Wichtig fÃ¼r Abstandsformatierung

%-------------------------------------------------------------------------

% serifenlose Schrift als Standard
% + alle fÃ¼r TeX benÃ¶tigten mathematischen
%   Schriften einschlieÃlich der AMS-Symbole
%\usepackage{cmbright}						
...
%-------------------------------------------------------------------------
% Anpassung der Kopf- und FuÃzeilen
% \usepackage[automark]{scrpage2}
% Korrekter Leerraum nach Befehlsdefinitionen
\usepackage{xspace}
% Dieses Package brauchen wir fÃ¼r den anderthalbzeiligen Abstand.
\usepackage{setspace}
...
%-------------------------------------------------------------------------
% Anpassung der Parameter, die TeX bei der Berechnung der ZeilenumbrÃ¼che verwendet:
%-------------------------------------------------------------------------
\tolerance 1414
\hbadness 1414
